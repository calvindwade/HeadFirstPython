...
def read_swim_data(filename):
    ...
    Given the name of a swimmer's file (filename), extract all the required data, then return it to the caller as a tuple. 
    """
    ...
    converts = []
    for t in times:
        # The minutes value might be missing, so guard against a crash. 
        if ":" in t:
